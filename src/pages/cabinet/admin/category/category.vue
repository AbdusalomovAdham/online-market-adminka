<template>
  <div class="page-header flex gap-12 items-center mb-16">
    <div class="title">
      ...
      <h1 class="white">Katigoriyalar</h1>
    </div>
...
import CreateModal from "@/components/modal/admin/category/category/Create.vue";
import UpdateModal from "@/components/modal/admin/category/category/Update.vue";
...
const cols = [
  ...
  { field: "name", title: "Katigoriya nomi", sort: false },
  { field: "parent_name", title: "Parent nomi", sort: false },
  { field: "status", title: "Katigoriya holati", sort: false },
